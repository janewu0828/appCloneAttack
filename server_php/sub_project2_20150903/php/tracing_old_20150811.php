...
$dblink                             = mysqli_connect("localhost", $username_dblink, $password_dblink,$database_dblink) or trigger_error(mysql_error(),E_USER_ERROR);
...
if($deviceid==$sess_deviceid){
    ...
    { 
        ...
        mysqli_query($dblink,$insertSQL) or die(mysql_error());
    }
    ...
    $rs                             = mysqli_query($dblink,$query_rs) or die(mysql_error());
