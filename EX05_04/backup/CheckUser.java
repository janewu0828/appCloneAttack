...
import static com.project.module.SendPostRunnable.server_url;
...
public class CheckUser
{
  ...
  String url = server_url + "php/app.php";    
  String app_id = null;
   ...
   * @param deviceid
   */
  public CheckUser(String app_id, String deviceid, String androidid)
  {
    super();
    this.app_id = app_id;
  ...
  public boolean checkUser()
  {
    ...
    pairs.add(new BasicNameValuePair("androidid", androidid));
