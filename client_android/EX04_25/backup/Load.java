...
public class Load
{
  ...
  public void loadJar(Context context)
  {
    try
    {
      ...
      //exe
      mMainInterface.showResult();
      
      //return
      EX04_25.mUserChoice = mMainInterface.ismUserChoice();
      EX04_25.intTimes = mMainInterface.getIntTimes();
      EX04_25.mMyChoice = mMainInterface.getmMyChoice();
